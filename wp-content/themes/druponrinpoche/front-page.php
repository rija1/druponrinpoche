    ...
    <li class="box2">
        ...
        <a href="<?php echo get_page_link($post)?>">
            ...
            <div class="inner">
                ...
                <p><?php pll_e('Thrangu Sekhar Retreat Center is situated in the hills forming the eastern rim of the Kathmandu Valley, just below a cave used by the revered Tibetan yogi, Milarepama'); ?></p>
            </div>
        </a>
