...
if( ! function_exists( 'dkr_enqueue_scripts' ) ) {
    function dkr_enqueue_scripts() {
        ...
        wp_enqueue_script( 'modal-js', get_template_directory_uri() . '/assets/js/jquery.modal.min.js', array('jquery'), null );
...
function insert_fb_in_head() {
    ...
    if(!has_post_thumbnail( $post->ID )) { //the post does not have featured image, use a default image
        $default_image="http://druponrinpoche.org/wp-content/themes/druponrinpoche/assets/images/logo_dharma_wheel_gold.webp"; //replace this with a default image on your server or an image in your media library
...
// Ultimate Member - Profile Pic on Registration
/**
