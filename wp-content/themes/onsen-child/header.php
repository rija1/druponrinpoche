                    ...
                    <div class="gutter clearfix">
                        ...
                        <nav class="menu-top-container">
                            <?php if ( has_nav_menu( 'onsen-menu' ) ) { ?>
                                <?php wp_nav_menu( array('container'=> '', 'theme_location' => 'onsen-menu', 'items_wrap'  => '<ul class="menu-top">%3$s</ul>','depth' => 2  ) ); ?>
                            <?php } else { ?>
                        ...
                        <nav class="menu-top-mob-container">
                            ...
                            <?php if ( has_nav_menu( 'onsen-menu' ) ) { ?>
                                <?php wp_nav_menu( array('container'=> '', 'theme_location' => 'onsen-menu', 'items_wrap'  => '<ul class="menu-top-mob">%3$s</ul>','depth' => 2  ) ); ?>
                            <?php } else { ?>
